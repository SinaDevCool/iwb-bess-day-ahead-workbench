...
describe("parseForecast", () => {
  it("uses UTC offsets to disambiguate repeated DST hours", () => {
    ...
    expect(parseForecast("02:00;1\n02:00;2", 2, -500, 4000, grid).errors[0].message).toContain(
      "ambiguous",
    );
    expect(
      parseForecast("2026-10-25T02:00:00+01:00;2\n2026-10-25T02:00:00+02:00;1", 2, -500, 4000, grid)
        .values,
    ).toEqual([1, 2]);
