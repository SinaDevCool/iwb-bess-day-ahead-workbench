# Build static assets once; the final Python image needs no Node server.
...
# Only demo persistence needs runtime write access; history requires durable hosting storage.
